...
struct layer{
    ...
    void (*forward_cudnn)   (struct layer, struct network);
    void (*backward_cudnn)  (struct layer, struct network);
    void (*update_cudnn)    (struct layer, update_args);
    int batch_normalize;
    int shortcut;
    int batch;
    int forced;
...
void forward_network(network *net,const char* mode);
void backward_network(network *net,const char* mode);
void update_network(network *net,const char* mode);
...
void forward_network_gpu(network *net,const char* mode);
void backward_network_gpu(network *net,const char* mode);
void update_network_gpu(network *net,const char* mode);
