...
route_layer make_route_layer(int batch, int n, int *input_layers, int *input_sizes, const char* mode)
{
    ...
    l.forward_cudnn = forward_route_layer_gpu;
    l.backward_cudnn= backward_route_layer_gpu;  
    l.delta_gpu =  cuda_make_array(l.delta, outputs*batch);
    l.output_gpu = cuda_make_array(l.output, outputs*batch);
    return l;
}

void resize_route_layer_gpu(route_layer *l, network *net)
{
