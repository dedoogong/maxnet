...
extern "C" void forward_maxpool_layer_gpu(maxpool_layer l, network net)
{
    ...
    forward_maxpool_layer_kernel<<<cuda_gridsize(n), BLOCK>>>(n, l.h, l.w, l.c, l.stride, 
																																 l.size, l.pad, 
																																 net.input_gpu, l.output_gpu, l.indexes_gpu);
...
extern "C" void backward_maxpool_layer_gpu(maxpool_layer l, network net)
{
    ...
    backward_maxpool_layer_kernel<<<cuda_gridsize(n), BLOCK>>>(n, l.h, l.w, l.c, l.stride,
																																	l.size, l.pad, 
																																	l.delta_gpu, net.delta_gpu, l.indexes_gpu);
    check_error(cudaPeekAtLastError());
}
